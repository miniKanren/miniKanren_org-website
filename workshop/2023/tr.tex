...
\begin{titlepage}
  ...
  % Uncomment the next line and replace "logo.png" with the path to your logo
  \includegraphics[width=0.7\textwidth]{mklogo.png}
  
  \vspace{1cm}
  
%%   {\LARGE Proceedings of the 2023 miniKanren and Relational Programming Workshop}
  
%%   \vspace{1cm}
  
%%   {\large William E. Byrd \\ and \\ Nada Amin}
