...
\includepdf[noautoscale,scale=1.07,pages=-,pagecommand={\thispagestyle{fancy}},addtotoc={1,chapter,1,{Towards a miniKanren with fair search strategies},p1}]{minikanren19-final1}

\ \\
\pagebreak

\includepdf[noautoscale,scale=1.07,pages=-,pagecommand={\thispagestyle{fancy}},addtotoc={1,chapter,2,{First-order miniKanren representation: Great for tooling and search},p2}]{minikanren19-final2}

\ \\
\pagebreak

\includepdf[noautoscale,scale=1.07,pages=-,pagecommand={\thispagestyle{fancy}},addtotoc={1,chapter,3,{Relational Interpreters for Search Problems},p3}]{minikanren19-final3}

\ \\
\pagebreak

\includepdf[noautoscale,scale=1.07,pages=-,pagecommand={\thispagestyle{fancy}},addtotoc={1,chapter,4,{Constructive Negation for MiniKanren},p4}]{minikanren19-final4}

\ \\
\pagebreak

\includepdf[noautoscale,scale=1.07,pages=-,pagecommand={\thispagestyle{fancy}},addtotoc={1,chapter,5,{Certified Semantics for miniKanren},p5}]{minikanren19-final5}

\ \\
\pagebreak

\includepdf[noautoscale,scale=1.07,pages=-,pagecommand={\thispagestyle{fancy}},addtotoc={1,chapter,6,{Relational Processing for Fun and Diversity},p6}]{minikanren19-final6}
